...
public class BlkDiablos extends Fragment {
    ...
    private void loadMonster() {
        ...
        //Creating our Cursor
        Cursor monsterCursor = myDbHelper.getReadableDatabase().rawQuery("select * from large_monsters where monsterName like \"Black%\"", null);
    ...
    private void loadMonsterItems(){
        myDbHelper.openDataBase();
        Cursor monsterItemCursor = myDbHelper.getReadableDatabase().rawQuery("select * from materials where (materialname like 'Black Dia%') " +
                "or (materialname like 'Diablos Fang') " +
                "or (materialname like 'blos medulla') " +
                "or (materialname like 'Wyvern Gem') " +
                "or (materialname like '%hardbone') " +
                "or (materialname like 'dash extract') " +
                "or (materialname like 'Diablos Tailcase')",null);
