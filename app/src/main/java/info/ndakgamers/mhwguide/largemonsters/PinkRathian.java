...
public class PinkRathian extends Fragment {
    ...
    private void loadMonster() {
        ...
        //Creating our Cursor
        Cursor monsterCursor = myDbHelper.getReadableDatabase().rawQuery("select * from large_monsters where monsterName like \"Pink%\"", null);
    ...
    private void loadMonsterItems(){
        myDbHelper.openDataBase();
        Cursor monsterItemCursor = myDbHelper.getReadableDatabase().rawQuery("select * from materials where (materialname like 'Pink%') " +
                "or (materialname like '%hardbone') " +
                "or (materialname like 'rathian ruby') " +
                "or (materialname like 'rathian wintalon') " +
                "or (materialname like 'rathian webbing') " +
                "or (materialname like 'rathian plate') " +
                "or (materialname like 'rathian spike +') " +
