...
public class Pukei extends Fragment {
...
//        myDbHelper = DatabaseHelper.getInstance(myView.getContext());
    ...
    private void loadMonster() {
        ...
        //Creating our Cursor
        Cursor monsterCursor = myDbHelper.getReadableDatabase().rawQuery("select * from large_monsters where monsterName like \"Pukei%\"", null);
    ...
    private void loadMonsterItems(){
        myDbHelper.openDataBase();
        Cursor monsterItemCursor = myDbHelper.getReadableDatabase().rawQuery("select * from materials where (materialname like 'Pukei%') " +
                "or (materialname like '%bone m') " +
                "or (materialname like 'bird%') " +
                "or (materialname like '%keenbone') " +
                "or (materialname like 'poison sac') " +
                "or (materialname like 'toxin sac')",null);
