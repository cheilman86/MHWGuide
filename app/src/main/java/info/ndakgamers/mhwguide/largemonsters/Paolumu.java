...
public class Paolumu extends Fragment {
    ...
    private void loadMonster() {
        ...
        //Creating our Cursor
        Cursor monsterCursor = myDbHelper.getReadableDatabase().rawQuery("select * from large_monsters where monsterName like \"Paolum%\"", null);
    ...
    private void loadMonsterItems(){
        myDbHelper.openDataBase();
        Cursor monsterItemCursor = myDbHelper.getReadableDatabase().rawQuery("select * from materials where (materialname like 'Paolum%') " +
                "or (materialname like '%keenbone') " +
                "or (materialname like 'wyvern gem') " +
                "or (materialname like '%keenbone') " +
                "or (materialname like 'monster bone l') " +
