...
public class Legiana extends Fragment {
    ...
    private void loadMonster() {
        ...
        //Creating our Cursor
        Cursor monsterCursor = myDbHelper.getReadableDatabase().rawQuery("select * from large_monsters where monsterName like \"Legia%\"", null);
    ...
    private void loadMonsterItems(){
        myDbHelper.openDataBase();
        Cursor monsterItemCursor = myDbHelper.getReadableDatabase().rawQuery("select * from materials where (materialname like 'Legia%') " +
                "or (materialname like 'monster bone +') " +
                "or (materialname like '%hardbone') " +
                "or (materialname like 'frost sac') " +
                "or (materialname like 'freezer sac')",null);
