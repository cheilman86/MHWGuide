...
public class GreatGirros extends Fragment {
    ...
    private void loadMonster() {
        ...
        //Creating our Cursor
        Cursor monsterCursor = myDbHelper.getReadableDatabase().rawQuery("select * from large_monsters where monsterName like \"Great G%\"", null);
    ...
    private void loadMonsterItems(){
        myDbHelper.openDataBase();
        Cursor monsterItemCursor = myDbHelper.getReadableDatabase().rawQuery("select * from materials where (materialname like 'Great Gir%') " +
                "or (materialname like '%bone L') " +
                "or (materialname like 'monster bone +') " +
                "or (materialname like 'paralysis sac') " +
                "or (materialname like 'omniplegia sac')",null);
