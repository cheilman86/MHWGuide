...
public class Jyuratodus extends Fragment {
    ...
    private void loadMonster() {
        ...
        //Creating our Cursor
        Cursor monsterCursor = myDbHelper.getReadableDatabase().rawQuery("select * from large_monsters where monsterName like \"Jyurato%\"", null);
    ...
    private void loadMonsterItems(){
        myDbHelper.openDataBase();
        Cursor monsterItemCursor = myDbHelper.getReadableDatabase().rawQuery("select * from materials where (materialname like 'Jyurato%') " +
                "or (materialname like '%bone M') " +
                "or (materialname like '%keenbone') " +
                "or (materialname like 'Aqua sac') " +
                "or (materialname like 'Wyvern Gem') " +
                "or (materialname like 'Torrent sac')",null);
