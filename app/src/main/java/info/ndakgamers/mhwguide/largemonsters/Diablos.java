...
public class Diablos extends Fragment {
    ...
    private void loadMonster() {
        ...
        //Creating our Cursor
        Cursor monsterCursor = myDbHelper.getReadableDatabase().rawQuery("select * from large_monsters where monsterName like \"Diablos%\"", null);
    ...
    private void loadMonsterItems(){
        myDbHelper.openDataBase();
        Cursor monsterItemCursor = myDbHelper.getReadableDatabase().rawQuery("select * from materials where (materialname like 'Diablos%') " +
                "or (materialname like 'twisted horn') " +
                "or (materialname like 'magestic horn') " +
                "or (materialname like 'wyvern gem') " +
                "or (materialname like 'dash extract') " +
                "or (materialname like 'monster bone +') " +
                "or (materialname like '%hardbone') " +
                "or (materialname like 'blos%')",null);
