...
public class MaterialItemAdapter extends CursorAdapter {
    public MaterialItemAdapter(Context context, Cursor cursor){
        super(context,cursor,0);
    }

    @Override
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        return LayoutInflater.from(context).inflate(R.layout.item_view_adapter, parent,false);
    }
