...
public class LargeMonsterAdapter extends CursorAdapter {

    TextView textView;
    ImageView imageView;

    public LargeMonsterAdapter(Context context, Cursor cursor){
        super(context,cursor,0);
    }

    @Override
    public View newView(Context context, Cursor cursor, ViewGroup parent) {
        return LayoutInflater.from(context).inflate(R.layout.large_monster_layout, parent,false);
    }
