 ...
 * Created on 4/4/2018.
 */
public class Noios extends Fragment {
    ...
    private void loadMonster(){
        ...
        //Creating our Cursor
        Cursor monsterCursor = myDbHelper.getReadableDatabase().rawQuery("select * from sml_monsters where monsterName like \"Noios%\"",null);
